...
{
///large step length for flat ground
/*  	_steplength(4) = 0.3;
	_steplength(5) = 0.3;	
	_steplength(6) = 0.3; */ 
...
///large step length for stair climbing: using using the cogimon_stair_basic.world for environment file
// 	///stair height:lift height
// // 	_lift_height_ref(3) = 0.03;
// 	_lift_height_ref(4) = 0.065;
// 	_lift_height_ref(5) = 0.08;
// 	_lift_height_ref(6) = 0.09;	
// 	_lift_height_ref(7) = 0.06;
//   	_steplength(3) = 0.28;
// 	_steplength(4) = 0.28;	
// 	_steplength(5) = 0.28;
// 	_steplength(6) = 0.28;
...
/// for yanlong huang:ICRA2020:variance step length:
///case1
// 	_steplength(5) = -0.06;
// 	_steplength(6) = -0.06;
// 	_steplength(7) = 0;
...
// 	_nT = round(_ts(0)/_dt);                                                          /// the number of one step cycle		
	...
	_ggg.setConstant(_GGG);                                            //// acceleration of gravity: 1*1 matrix: matrix operations
         ...
         cout<<"start mpc initialization1x"<<endl; 		                      	          //// number of sampling time predictive window: <= 2*_nT;
...
/*	_flag.setZero(_nsum);	        // 	 store n_vis: actual following step numbers under predictive window
	...
	_beltathetax = 1000; _beltathetay = 1000;
	  ...
	  //////// for methx ==2:reactive step + body inclination + height variance: for flat ground walking and up-down stairs: offline !!!! to guarantee the solution: _alphay and _beltay should be large enough
          //////for Tstep=0.6s, _nh=12;==0.7(13)====step flag ==0
// 	  _Rx = 1;            _Ry = 10;            _Rz =1;
// 	  _alphax = 10;       _alphay = 50;        _alphaz = 100; 
// 	  _beltax = 10000;    _beltay = 10000;     _beltaz = 20000000;
// 	  _gamax =  50000000; _gamay = 50000000;  _gamaz = 200;
// 	  _Rthetax = 1; _Rthetay = 1;
// 	  _alphathetax =1; _alphathetay = 1;
// 	  _beltathetax = 1000; _beltathetay = 1000;
	  
// 	  //////for Tstep=0.7s, _nh=12;::::method_flag=2:flat ground: /////variable step parameters walking: yanlong huang ICRA2020
//           //case1: steplength=0.15
// 	  _Rx = 10;           _Ry = 10;            _Rz =10;
// 	  _alphax = 50;     _alphay = 20;        _alphaz = 100; 
// 	  _beltax = 40000;   _beltay = 25000;     _beltaz = 50000000;
// 	  _gamax =  50000000; _gamay = 50000000;  _gamaz = 200;
// 	  _Rthetax = 1; _Rthetay = 1;
// 	  _alphathetax =10; _alphathetay = 10;
// 	  _beltathetax = 1000000; _beltathetay = 1000000;
	  
// 	  ///case 2: step length = 0.15
// 	  _Rx = 10;           _Ry = 10;            _Rz =10;
// 	  _alphax = 100;     _alphay = 50;        _alphaz = 100; 
// 	  _beltax = 40000;   _beltay = 20000;     _beltaz = 50000000;
// 	  _gamax =  50000000; _gamay = 50000000;  _gamaz = 200;
// 	  _Rthetax = 1; _Rthetay = 1;
// 	  _alphathetax =10; _alphathetay = 10;
// 	  _beltathetax = 1000000; _beltathetay = 1000000;
//           //case3: steplength=0.15
// 	  _Rx = 10;           _Ry = 10;            _Rz =10;
// 	  _alphax = 10;     _alphay = 50;        _alphaz = 100; 
// 	  _beltax = 40000;   _beltay = 30000;     _beltaz = 50000000;
// 	  _gamax =  50000000; _gamay = 50000000;  _gamaz = 200;
// 	  _Rthetax = 1; _Rthetay = 1;
// 	  _alphathetax =10; _alphathetay = 10;
// 	  _beltathetax = 1000000; _beltathetay = 1000000;
         //case4,5: steplength=0.15
/*	  _Rx = 10;           _Ry = 10;            _Rz =10;
	  _alphax = 10;     _alphay = 50;        _alphaz = 100; 
	  _beltax = 30000;   _beltay = 20000;     _beltaz = 50000000;
	  _gamax =  50000000; _gamay = 50000000;  _gamaz = 200;
	  _Rthetax = 1; _Rthetay = 1;
	  _alphathetax =10; _alphathetay = 10;
	  _beltathetax = 1000000; _beltathetay = 1000000;	*/  
...
// // 	  //////for Tstep=0.7s, _nh=12;::::method_flag=2:flat ground: /////constant or variable step parameters walking
// 	  _Rx = 10;           _Ry = 10;            _Rz =10;
// 	  _alphax = 100;     _alphay = 50;        _alphaz = 100; 
// 	  _beltax = 60000;   _beltay = 20000;     _beltaz = 50000000;
// 	  _gamax =  50000000; _gamay = 50000000;  _gamaz = 200;
// 	  _Rthetax = 1; _Rthetay = 1;
// 	  _alphathetax =10; _alphathetay = 10;
// 	  _beltathetax = 1000000; _beltathetay = 1000000;
  
// 	  //////for Tstep=0.7s, _nh=12;::::method_flag=2:basic stair /////
// 	  _Rx = 10;           _Ry = 10;            _Rz =100;
// 	  _alphax = 100;     _alphay = 100;        _alphaz = 1000; 
// 	  _beltax = 80000;   _beltay = 20000;     _beltaz = 50000000;
// 	  _gamax =  50000000; _gamay = 50000000;  _gamaz = 200;
// 	  _Rthetax = 1; _Rthetay = 1;
// 	  _alphathetax =10; _alphathetay = 10;
// 	  _beltathetax = 10000000; _beltathetay = 10000000;
/*	  //////for Tstep=0.7s, _nh=12;::::method_flag=2: large stair /////
	  _Rx = 10;           _Ry = 10;            _Rz =100;
	  _alphax = 100;     _alphay = 100;        _alphaz = 1000; 
	  _beltax = 80000;   _beltay = 20000;     _beltaz = 50000000;
	  _gamax =  50000000; _gamay = 50000000;  _gamaz = 200;
	  ...
	  _alphathetax =10; _alphathetay = 10;
	  _beltathetax = 10000000; _beltathetay = 10000000;*/		  
/*	  //////for Tstep=1s, _nh=12;::::method_flag=2:stair /////0.25-0.35
	  _Rx = 10;           _Ry = 10;            _Rz =100;
	  _alphax = 100;     _alphay = 100;        _alphaz = 1000; 
	  _beltax = 100000;   _beltay = 20000;     _beltaz = 50000000;
	  _gamax =  50000000; _gamay = 50000000;  _gamaz = 200;
	  _Rthetax = 1; _Rthetay = 1;
	  _alphathetax =10; _alphathetay = 10;
	  _beltathetax = 10000000; _beltathetay = 10000000;	*/  
