...
//int kmp::kmp_insertPoints(vec inPoint, vec outPoint, mat outVar)  // point format, mean: 1×inDim, output:1×outDim, sigma:[first row, second row, ...], i.e., [1×outDim 1×outDim ...1×outDim]
